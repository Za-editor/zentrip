...
window.addEventListener("scroll", () => {
  if (window.scrollY > 10) {
    ...
    navbar.classList.add("backdrop-blur-md", "z-[9999]");
  } else {
    ...
    navbar.classList.remove("backdrop-blur-md", "z-[9999]");
  }
});
...
function renderDestinations(data) {
  ...
  if (bodyId === "destinations") {
    ...
    data.forEach((booking) => {
      ...
      class="flex flex-col md:flex-row p-3 md:px-20 lg:px-30 xl:px-40 gap-5 md:gap-5 xl:gap-10 text-[#4741A6] justify-center " 
    >
      <div
